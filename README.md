...
- **Seamless Port Selection:** Automatically finds an available port and binds to `127.0.0.1` internally. **No port forwarding or manual port configuration required.**
